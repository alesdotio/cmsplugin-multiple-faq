...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('cmsplugin_multiple_faq_faqlist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ))
        db.send_create_signal('cmsplugin_multiple_faq', ['FAQList'])

        # Adding model 'FAQEntry'
        db.create_table('cmsplugin_multiple_faq_faqentry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('faq_list', self.gf('django.db.models.fields.related.ForeignKey')(related_name='faq_entries', to=orm['cmsplugin_multiple_faq.FAQList'])),
        ...
        db.send_create_signal('cmsplugin_multiple_faq', ['FAQEntry'])

        # Adding model 'FAQPlugin'
        db.create_table('cmsplugin_faqplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('faq_list', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cmsplugin_multiple_faq.FAQList'])),
        ))
        db.send_create_signal('cmsplugin_multiple_faq', ['FAQPlugin'])


    def backwards(self, orm):
        
        # Deleting model 'FAQList'
        db.delete_table('cmsplugin_multiple_faq_faqlist')

        # Deleting model 'FAQEntry'
        db.delete_table('cmsplugin_multiple_faq_faqentry')
